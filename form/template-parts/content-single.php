            ...
            <div class="col-md-12">
                ...
                <article id="post-<?php echo $post_id; ?>" <?php post_class("entry single"); ?>>
                  ...
                  <div class="about-author clearfix <?php if ( $islemag_single_post_hide_author == true ) echo 'islemag_hide'; ?>">
                      <h3 class="title-underblock custom"><?php echo esc_attr( 'Автор:','islemag' ) ?> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php the_author(); ?></a></h3>
                      <?php
